...
exit();    // c est un docteur qui veut acceder a le profile d un patient
}

  $conn = new mysqli("localhost", "id1811609_root", "aymen","id1811609_my_db");
  $sql = "SELECT * FROM patient WHERE user='".$_SESSION['user']."'"; // le patient peut voir les profiles des medcins
...
function edit(x){
  ...
  var user = document.getElementById(x).value;
    ...
    hr.onreadystatechange = function() { // la fonction a appeler quand le statut change
...
<table width="50%" border="0">
    <tr>
      ...
      <td><strong><?php echo 'Mr/Mme.'.$row['nom']; ?></strong><button  onClick="myfunction('nom')" ><span class="glyphicon glyphicon-edit" ></span></button>   <input id="nom" class="edit" onBlur="edit('nom')" type=text  >
</td>

    </tr>
  </tr>
    <tr>
      <td><b>e-mail :  </b><?php echo $row['email']; ?><button onclick="myfunction('email')" ><span class="glyphicon glyphicon-edit"></span></button> <input onBlur="edit('email')" type="email" id="email" class="edit" required ></td>
    </tr>
    <tr>
      <td><b>tel : </b><?php echo $row['tel']; ?><button onclick="myfunction('tel')" ><span class="glyphicon glyphicon-edit"></span></button><input  class="edit" required type="text" id="tel" onBlur="edit('tel')" ></td>
    </tr>
 </table>
<table class="grey" border="0" width="50%" >
  <tr>
 <td width="50%">   date de naissance :</td> <td><?php echo $row['dateN']?><button style="background-color:white;" onClick="myfunction('date')"><span class="glyphicon glyphicon-edit"></span></button> <input id="date" class="edit" onBlur="edit('date')" type="date" name="dateN" ></td>
   </tr>
  <tr>
 <td width="50%">   Wilaya :</td> <td><?php echo $row['wilaya']?><button style="background-color:white;" onClick="myfunction('wilaya')" ><span class="glyphicon glyphicon-edit"></span></button></td>
  ...
  <tr>
  <td width="50%">   Sex :</td> <td><?php echo $row['sex']?><button style="background-color:white;" onClick="myfunction('sex')" ><span class="glyphicon glyphicon-edit"></span></button>  </td>
    </tr>
    <tr> <td></td>
    <td>
    <select id="sex" class="edit" onBlur="edit('sex')"  >
